...
import '../utils/fruit_data_script.dart';
...
class _FruitCategoryScreenState extends State<FruitCategoryScreen> {
  ...
  Future<void> _initializeData() async {
    try {
      print('🍎 Initializing fruit products...');
      // Pastikan data produk buah tersedia
      await FruitDataScript.initializeFruitProducts();
      print('✅ Fruit products initialized');
    } catch (e) {
      print('❌ Error initializing fruit products: $e');
    } finally {
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'Produk buah akan segera tersedia',
                            style: GoogleFonts.poppins(
