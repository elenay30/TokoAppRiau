...
class _RamadhanProductsScreenState extends State<RamadhanProductsScreen> {
  ...
  Future<void> _loadFirestoreProducts() async {
    try {
      ...
      // Ambil produk dari kategori 'Ramadhan' atau 'Festival'
      QuerySnapshot snapshot = await _firestore
          .collection('products')
          .where('category', whereIn: ['Ramadhan', 'Festival', 'Special'])
          .get();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Jika tidak ada produk dari Firebase, tampilkan pesan
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          'Belum ada produk Ramadhan di database',
                          style: GoogleFonts.poppins(
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Tambahkan produk dengan kategori "Ramadhan", "Festival", atau "Special"',
                          style: GoogleFonts.poppins(
  ...
  // Modern Product Card dengan Consumer - SAMA SEPERTI DRINKS SCREEN
  ...
  // Product Image Widget - SAMA SEPERTI DRINKS SCREEN
  ...
  // Quantity Control - SAMA SEPERTI DRINKS SCREEN
  ...
  // Add to Cart - SAMA SEPERTI DRINKS SCREEN
