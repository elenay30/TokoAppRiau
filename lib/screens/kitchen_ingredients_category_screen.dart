// File: lib/screens/kitchen_ingredients_category_screen.dart - FIXED VERSION
...
class KitchenIngredientsCategoryScreen extends StatefulWidget {
  const KitchenIngredientsCategoryScreen({Key? key}) : super(key: key);

  @override
  State<KitchenIngredientsCategoryScreen> createState() => _KitchenIngredientsCategoryScreenState();
}

class _KitchenIngredientsCategoryScreenState extends State<KitchenIngredientsCategoryScreen> {
  ...
  Future<void> _initializeData() async {
    try {
      print('🥄 Initializing kitchen ingredients products...');
      await KitchenIngredientsDataScript.initializeKitchenIngredientsProducts();
      print('✅ Kitchen ingredients products initialized');
    } catch (e) {
      print('❌ Error initializing kitchen ingredients products: $e');
    } finally {
  ...
  // AppBar Widget - Same as original
  ...
  // Promo Banner Widget - Same as original
  ...
  // Section Title Widget - Same as original
  ...
  // Loading State Widget - Same as original
  ...
  // Empty State Widget - Same as original
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Produk bahan dapur akan segera tersedia',
            style: GoogleFonts.poppins(
  ...
  // (Discount Badge, Rating Badge, Add to Cart Button, Product Image, Quantity Control, Add to Cart Method, Login Dialog)
              ...
              child: Container(
                ...
                child: Center(
                  child: Icon(
                    ...
                    size: 14,
                    color: quantity > 1 ? Colors.green[700] : Colors.red,
                  ),
                ),
              ),
            ),
