// File: lib/screens/food_category_screen.dart - UPDATED WITH DATABASE LOGIC
...
class _FoodCategoryScreenState extends State<FoodCategoryScreen> {
  ...
  void initState() {
    super.initState();
    _initializeData(); // Update method ini
  ...
  Future<void> _initializeData() async {
    try {
      ...
      // Pastikan data produk makanan tersedia
  ...
  // Modern Product Card (sama seperti DrinksCategoryScreen)
